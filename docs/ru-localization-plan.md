...
| Статус | в работе: §4.7 готов; P0 — промпты, tool/skill описания, библиотека промптов и русские синонимы намерений сделаны; остались данные стандартов оформления и часть inline-промптов |
